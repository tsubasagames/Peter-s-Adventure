...
**Project:** PETER’S ADVENTURE  
**Owner:** TsubasaGames  
**Authorized Organization:** GENUINE SCHOOL  
...
### 1. COPYRIGHT
Copyright © 2026 **TsubasaGames**. All rights reserved. 
All assets, including source code, graphics, and audio, remain the exclusive property of TsubasaGames.

### 2. PERMITTED USE
Permission is granted to individuals to:
* **Download and View:** Access the source code for personal and educational purposes.
* **Private Modification:** Edit the code for **private, personal use only** on a local machine.
...
### 5. BUG REPORTING
If you discover any bugs or technical issues, do not distribute a modified version of the project. Please report them directly to the owner.

**Contact:** [marcellogames1350@gmail.com](mailto:marcellogames1350@gmail.com)

---

**Violation of these terms constitutes an infringement of copyright law.** **TsubasaGames**
